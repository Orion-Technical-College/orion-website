(function ($) {
  ...
  /*
  |--------------------------------------------------------------------------
  | Template Name: Orion Technical College
  | Author: Arjunweb Solutions
  |--------------------------------------------------------------------------
  |--------------------------------------------------------------------------
  | TABLE OF CSS SECTIONS:
  |--------------------------------------------------------------------------
  |
  | 1. Preloader
  | 2. Mobile Menu
  ...
  */
  ...
  --------------------------------------------------------------*/
  function mainNav() {
    $('.td_nav').after('<span class="td_menu_toggle"><span></span></span>');
...
$(window).scroll(function(){
  if ($(this).scrollTop() > 100) {
     $('.td_site_header').addClass('newClass');
  } else {
     $('.td_site_header').removeClass('newClass');
  }
});
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <CardDescription>Enter your credentials to access EMC Workspace</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          {error && (
            <div className="p-3 text-sm text-status-denied bg-status-denied/10 rounded-md border border-status-denied/20">
              {error}
            </div>
          )}
